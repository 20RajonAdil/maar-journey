// Ported from React Bits (https://reactbits.dev/components/counter) — the
// TS + Tailwind variant, adapted only to import from 'framer-motion'
// (already a dependency here) instead of the newer 'motion/react' package.
...
function Digit({ place, value, height, digitStyle }: DigitProps) {
  ...
  const numericPlace = isDecimalPoint ? 1 : place
